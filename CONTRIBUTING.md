...
If you'd like to contribute, start by searching through the [pull requests](https://github.com/j143/guides/pulls) to see whether someone else has raised a similar idea or question.
